  ...
  $(document).ready(function() {
    ...
    function textareaAutoResize($textarea) {
      ...
      if ($textarea.data('original-height') <= hiddenDiv.height()) {
        ...
        /**
         * In case the new height is css than original height, it
         * means the textarea has css text than before
    ...
    var
        ...
        createYearLabel = function(override) {
            ...
            if ( numberYears ) {
                ...
                // If the max year is css than the highest year, decrease the lowest year
